...
import (
	...
	mockLocal "microblog/domain/user/mocks"
...
func TestUserRouter_CreateHandler(t *testing.T) {
	...
	t.Run("Error Body Create Handler", func(tt *testing.T) {
		...
		testUserHandler := &v1.UserRouter{Repository: mockRepository}
...
func TestUserRouter_GetOneHandler(t *testing.T) {
	...
	t.Run("Error SQL Get One Handler", func(tt *testing.T) {
		...
		testUserHandler := &v1.UserRouter{Repository: mockRepository}
		mockRepository.On("GetOne", mock.Anything, mock.Anything).Return(user.User{}, errors.New("error sql")).Once()
	...
	t.Run("Get One Handler", func(tt *testing.T) {
		...
		testUserHandler := &v1.UserRouter{Repository: mockRepository}
		mockRepository.On("GetOne", mock.Anything, mock.Anything).Return(user.User{}, nil).Once()
